...
mkdir -p "${LOCAL_PATH}/pdns/isu2/"
rsync -avr --exclude='' isu2:/etc/powerdns/ "${LOCAL_PATH}/pdns/isu2/"
mkdir -p "${LOCAL_PATH}/dnsdist/isu2/"
rsync -avr --exclude='' isu2:/etc/dnsdist/ "${LOCAL_PATH}/dnsdist/isu2/"
